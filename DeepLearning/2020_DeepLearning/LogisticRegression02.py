...
loaded_data = np.loadtxt('C:/Users/user/PycharmProjects/DeepLearning/data/XOR.txt', delimiter=',', dtype=np.float32)
...
W1 = np.random.rand(2,hidden_nodes)
b1 = np.random.rand(hidden_nodes)

W2 = np.random.rand(hidden_nodes,1)
b2 = np.random.rand(1)
