...
class data_preprocessing_csv:
    ...
    def __init__(self, data_path, data_name, dividing_percent = 0.3):

        self.path = data_path + '/' + data_name + '.csv'
        self.data_path = data_path
        self.data_name = data_name + '.csv'
        self.dividing_percent = dividing_percent # for training_data
        self.training_data_name = data_name + '_train.csv'
        self.test_data_name = data_name + '_test.csv'
        self.norm_data_name = data_name + '_norm.csv'
        self.onehot_data_name = data_name + '_t_onehot.csv'
        self.count = 0
...
'''obj = data_preprocessing_csv('./data', 'mnist_train')
obj.save_onehot_t_data(0, 10)'''

'''obj = data_preprocessing_csv('./data', 'mnist_train')
obj.normalization(0, True)

obj = data_preprocessing_csv('./data', 'mnist_test')
obj.normalization(0, True)'''

'''obj = data_preprocessing_csv('./data', 'ThoracicSurgery', 0.4)
obj.normalization()
obj2= data_preprocessing_csv('./data', 'ThoracicSurgery_norm')
obj2.distribution()'''

'''obj = data_preprocessing_csv('./data', 'diabetes')
obj.normalization(-1, True)
obj2 = data_preprocessing_csv('./data', 'diabetes_norm', 0.4)
obj2.distribution()'''

'''obj = data_preprocessing_csv('./data', 'ThoracicSurgery')
obj.normalization(Logistic = True)

obj2 = data_preprocessing_csv('./data', 'ThoracicSurgery_norm', 0.4)
obj2.distribution()'''

'''obj = data_preprocessing_csv('./data', 'airplane_test')
obj.normalization()
obj2 = data_preprocessing_csv('./data', 'airplane_train')
obj2.normalization()'''